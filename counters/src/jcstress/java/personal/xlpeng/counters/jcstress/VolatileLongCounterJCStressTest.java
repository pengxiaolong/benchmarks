...
import personal.xlpeng.counters.VolatileLongCounter;

import static org.openjdk.jcstress.annotations.Expect.ACCEPTABLE;
import static org.openjdk.jcstress.annotations.Expect.FORBIDDEN;

@JCStressTest
@Description("Test VolatileLongCounter is thread-safe")
...
@State
public class VolatileLongCounterJCStressTest {
    private final Counter counter = new VolatileLongCounter();
